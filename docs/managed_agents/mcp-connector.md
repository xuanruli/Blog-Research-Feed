...
2. **Session creation** supplies auth for those servers by referencing a pre-registered [vault](https://platform.claude.com/docs/en/managed-agents/vaults).
