"""Tests for brf.clients.x.fetch_user_recent — referenced-tweet resolution."""
...
from brf.clients import x as x_client
...
def test_excludes_replies_keeps_retweets(monkeypatch):
    """The request drops only replies and asks for referenced-tweet expansions."""
